...
class GameObject(pygame.sprite.Sprite):
      def __init__(self, img, x, y, tile_size, map_size, kind = None, status = True, identity):
...
class Ghost(GameObject):
      def __init__(self, x, y, tile_size, map_size):
          ...
          self.direction = 0 #Направление передвижения.
          self.velocity = 4.0 / 10.0 #Скорость в клетках за 1 тик.
          self.damage = 1
          self.set_type('Ghost')
